    ...
    <div className="flex items-center space-x-3">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="flex items-center space-x-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-full px-4 py-2 hover:bg-white/90 dark:hover:bg-gray-800/90 transition-all shadow-sm"
        >
          {/* Profile Picture */}
          ...
          <>
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-20 overflow-hidden">
              ...
              <div className="py-2">
                <Link 
                  href="/profile"
                  className="w-full px-6 py-3 text-left hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center space-x-3"
                  onClick={() => setIsDropdownOpen(false)}
                >
                ...
                <button 
                  ...
                  className="w-full px-6 py-3 text-left hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors flex items-center space-x-3 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300"
                >
